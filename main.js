...
// let evens = positiveNumbers.filter(Number => Number % 2 == 0);
//   console.log("your even numbers are: " + evens)

// // Challenge 4
// // Console.log out the even numbers in the following array, INCLUDING the negative ones. There should be four total printings.

// const mixedSignNumbers = [3, 15, 14, -2, -3, -8, -103, 4];
// let evens2 = mixedSignNumbers.filter(Number => Number % 2 == 0);
//   console.log("your even numbers are: " + evens2)
...
// let count3 = 3
// for (let i = 3; count3 <= 12;count3 ++){
//    console.log(students[count3])
//  }
...
// let sliced2 = dinosaurs.splice(4,6);
...
// let together = dinosaurs.join("*" + sliced2);
// console.log(together);

// // Challenge 14
// // Use .reverse to reverse the dinosaur array and then log out the original array. .reverse DOES change the original array.

// let rev = dinosaurs.reverse();
// console.log(dinosaurs);
